...
<div class="w3-row">
  ...
  <div class="w3-col m3">
    ...
    <div class="w3-card w3-round w3-white">
      ...
      <hr>
       <h4 class="w3-center bold text-shadow: 2px 2px #FF0000" style="color:black" ;>MY PROFILE : CLIENT</h4> 
       <hr></hr>
...
if (isset($_POST['done'])) 
{
 ...
 if (empty($Type)) 
   ...
   if (!isset($errors)) 
  {
      ...
      $sql = 'INSERT INTO client_demand_post (b_username,b_name,b_email,b_phone,category,type,product_name,est_price,quantity,pro_details,de_place) VALUES (?,?,?,?,?,?,?,?,?,?,?)';
      ...
      echo "<script>alert('Information Store Sucessfully'); 
                window.location='c_my_post.php'</script>";
      ...
      $sql_1 = 'INSERT INTO client_product_comments (product_id,client_username) VALUES (?, ?)';
      ...
      {
          $sql = 'INSERT INTO client_products_images (product_id,filename,img_user) VALUES (?, ?,?)';
 ...
 <div class="w3-col m7">
    ...
    <div class="w3-row-padding">
      <div class="w3-col m12">
        <div class="w3-card w3-round w3-white">
          <div class="w3-container w3-padding w3-gray w3-opacity-min">
            <h3 style="color:white" ;><b>Post Your Request</b></h3>

            <br>
            <h6 style="color:white" ;><b>Product Information :</b></h6>
           
            <form method="post" action="c_profile.php" class="w3-container w3-card-4 w3-light-grey" enctype="multipart/form-data">
            <br>
             ...
             <p><label>Product Category</label></p>
               ...
               <select class="form-control" name="#">
                  <option value="Cars" selected>Fruits and vegetable</option>
                  <option value="Electronics">Meat and Fish</option>
                  <option value="Furnitures">Homemade</option>
                  <option value="Real estate">Worker</option>
  ...
  <button onclick="window.location.href='c_search.php';" class="w3-button w3-block w3-theme-l1 w3-left-align w3-hover-green"> 
    <i class="fa fa-search fa-fw w3-margin-right"></i>Search Products</button>

    <button onclick="window.location.href='c_my_post.php';" class="w3-button w3-block w3-theme w3-left-align w3-hover-green"> 
