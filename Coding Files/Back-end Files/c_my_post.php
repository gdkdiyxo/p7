       ...
       $sql = "SELECT * FROM client_demand_post LEFT JOIN client_products_images  
                ON client_products_images.product_id = client_demand_post.b_product_id LEFT JOIN 
                 client_product_comments ON client_product_comments.product_id = client_demand_post.b_product_id WHERE 
                  client_demand_post.b_username='$use' LIMIT 5";
           ...
           if(isset($_SESSION['user_name']))
         {
          echo "
                 <tr>
                  ...
                  <td> <button class='btn btn-success btn-sm'><a href='c_my_post_details.php?product_id=" .$row['b_product_id'] . "'>VIEW</a></button>
                  </td>

                 
                  <td><button class='btn btn-danger btn-sm'><a href='c_delete_my_post.php?product_id=" .$row['b_product_id'] . "'>
                      Delete</a></button>
                  </td>
