...
<head>
 ...
 <title>Request Product Details</title>
...
<br />
 <br />
   <br></br>
    <h2 class="set-title" align="center"><u>Requested Product Specification</h2></u>
    <br>
         ...
         <div class="modal-content">
           <div class="modal-body">                   
            ...
            <div class="form-group">
             <form method="post" action="demand_post_c_details.php" enctype="multipart/form-data">
...
<?php
   ...
   if (isset($_POST['ok'])) 
  {
     ...
     $sql = "UPDATE client_product_comments SET vendor_username='$use',vendor_name='$n_name',vendor_phone='$p_phone',
               vendor_comment= '$c_comment' , comment_time = now() 
   ...
   else 
  {
      echo "<script>alert('Error occured replying'); 
            window.location='demand_post_c_details.php'</script>";
