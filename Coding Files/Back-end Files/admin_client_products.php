...
#my_post  th {
  ...
  text-align: center;
  font-size : 18px;
  background: linear-gradient(to bottom, #336699 0%, #0099cc 100%);
  color: white;
}
  ...
  ?>
     ...
     <?php
      ...
      ON client_products_images.product_id = client_demand_post.b_product_id LEFT JOIN 
       client_product_comments ON client_product_comments.product_id = client_demand_post.b_product_id ";
        ...
        while ($row=mysqli_fetch_assoc($data))
      {
           ...
           if(isset($_SESSION['user_name']))
         {
           echo "
               ...
               <td>Cli. Reply : ".$row['client_reply']." <hr style='height:2px;border-width:0;color:black;background-color:black'> Vendors's
                  Username :".$row['vendor_username']."  <br />
                  Name : ".$row['vendor_name']."   <br />
                  Phone : ".$row['vendor_phone']."   <br />
                  Comment : ".$row['vendor_comment']."   <br />
