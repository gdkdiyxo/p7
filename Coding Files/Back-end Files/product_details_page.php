                ...
                <nav>
                  <ul class="nav topnav">
                    ...
                    if (isset($_SESSION['user_name'])) {
                      ...
                      <a href='buyer_own_post.php''>My Products</a>
                      <a href='#''>My Bid</a>
                      ...
                      <a href='seller_own_post.php'>My Products</a>
                      <a href='#''>My Bid</a>
          ...
          <div class="container">
            <div class="col-md-12">
              <div class="product col-md-3 service-image-left">
                ...
                if ($type == 0) {
                  ...
                  //echo "Paisi";
                  $sql = "SELECT * FROM buy_products_demand,b_products_images 
               WHERE buy_products_demand.b_product_id=b_products_images.product_id 
               AND buy_products_demand.b_product_id= $p_id LIMIT 1";
            ...
            <center>
             ...
             ";
                ...
                if ($type == 1) {
                  $sql = "SELECT * FROM sell_products_demand,s_products_images 
                WHERE sell_products_demand.s_product_id=s_products_images.product_id
                AND sell_products_demand.s_product_id=$p_id LIMIT 1";
             ...
             AND buy_products_demand.b_product_id= $p_id LIMIT 1";
                ...
                if ($result = mysqli_query($conn, $sql)) {
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $_SESSION['user_id_ForProduct'] = $row['buyer_user_id'];
        ...
        <hr>
          ...
          <div class='form-group'>
                  ...
                  <?php
                       ...
                       echo $user_id;
                       $product_name = $_SESSION['product_name_ForBuyer'];
                       //echo $product_name;
                       $product_id = $_SESSION['product_id_ForBuyer'];
                       //echo $product_id;
                       $user_id_ForProduct = $_SESSION['user_id_ForProduct'];
                       //echo $user_id_ForProduct;
                      ...
                      if (isset($_POST['bid_now_buyer'])) {
                        // echo $_SESSION['product_name_ForBuyer'];
                        // echo $_SESSION['user_id'];
                        
                        $bidding_price = $_POST['bidding_price'];
                        echo $bidding_price,$user_id,$user_id_ForProduct,$product_id;

                        // $bidlist_add_buyer = "INSERT INTO buyer_bidlist(bid_user_id,product_user_id,product_id,bid_price)
                        //                         VALUES('$user_id','$user_id_ForProduct','$product_id','$bidding_price')";

                          $sql = "INSERT INTO `buyer_bidlist` (`bid_user_id`, `product_user_id`, `products_id`, `bid_price`,`status`) 
                                                VALUES ($user_id,$user_id_ForProduct,$product_id,$bidding_price, '1')";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($ps == $status) {
                      ...
                      <div class='product-title'><h2><b>Product Name : " . $row['product_name'] . "</b></h2></div>
                       ...
                       <h6>Product ID : " . $row['s_product_id'] . "</h6>  
                       <h6> Type : <b> <font color='#FF1493'> " . $row['type'] . " </font></b></h6> 
