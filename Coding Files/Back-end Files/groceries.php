      ...
      <div class="container">
        <div class="row">
          ...
          <div class="span8">
            ...
            <div class="row">
              <div class="span8">
                <h4 class="title">Recent Grocery<strong> Products</strong></h4>
       ...
       <?php
         ...
         // AND vendor_product_post.Active = 1
          ...
          $sql = "SELECT * FROM vendor_product_post,vendor_products_images 
            WHERE vendor_product_post.b_product_id = vendor_products_images.product_id AND vendor_product_post.category='Groceries'
           ...
           if ($result = mysqli_query($conn, $sql)) 
          {
               while ($row = mysqli_fetch_assoc($result)) 
              {
                ...
                <div id="pagination">
                  ...
                  <a href="groceries.php" class="inactive">2</a>
