...
<!---------------------------------   Input Form ( Change Password )  ---------------------------->
      ...
      <form method="post" action="v_profile_edit.php" >
  ...
  {              
    ...
    $sql = "SELECT password FROM vendor_signup WHERE username='$use'"; 
     ...
     while ($row = mysqli_fetch_array($result)) 
    {
           ...
           if($pass == $oldpass)
          {
             ...
             if($newpassword == $confirmnewpassword)
            {
              ...
              $up ="UPDATE vendor_signup SET password='$confirmnewpassword' WHERE username='$use'";
               ...
               if($upda)
              {
                  ...
                  session_destroy();
                    ...
                    window.location='v_profile_edit.php'</script>";
                 }
...
?>
  ...
  <a onclick="window.location.href='v_account_delete.php';" class="w3-bar-item w3-button w3-block w3-theme w3-left-align w3-hover-red" href="#" data-target="#changepassword" data-toggle="modal">

  <i class="fa fa-lock fa-fw w3-margin-right"></i> Delete Account</a>
   <div id="Demo2" class="w3-hide w3-container">
    <div class="w3-row-padding">
    </div>
    </div>
...
<div class="w3-col m7">
      ...
      <div class="w3-col m12">
        <div class="w3-card w3-round w3-white">
          <div class="w3-container w3-padding w3-grayscale">
            ...
            <form method="post" action="v_profile_edit.php" class="w3-container w3-card-4 w3-light-grey">
            <br>
           ...
           <input type="text" class="form-control" placeholder="Current Addtress" name="address">
  ...
  {              
    ...
    $up ="UPDATE vendor_signup SET firstname='$_POST[first_name]',lastname='$_POST[last_name]',phone='$_POST[phone]',
