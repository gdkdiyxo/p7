   ...
   <section class="product">
	 <div class="product__photo">
        ...
        // $p_id = $_GET['product_id'];
         ...
         $sql = " SELECT * FROM client_demand_post LEFT JOIN client_products_images  
                  ON client_products_images.product_id = client_demand_post.b_product_id LEFT JOIN 
                   client_product_comments ON client_product_comments.product_id = client_demand_post.b_product_id WHERE 
                    client_demand_post.b_username='$use' AND client_demand_post.b_product_id= $p_id LIMIT 1 ";
           ...
           if ($result = mysqli_query($conn, $sql)) 
         {
           ...
           while ($row = mysqli_fetch_assoc($result)) 
          {
             ...
             echo "  
              ...
              <h5>Comment Received From Vendor :</h5> Comment Time : ".$row['comment_time']." <br /> Username : ".$row['vendor_username']." <br/>Name : <strong>".$row['vendor_name']."</strong> 
              <br/> Phone : ".$row['vendor_phone']." <br/> Comment : ".$row['vendor_comment']." 
              <hr style='height:1px;border-width:0;color:black;background-color:black'>


              <form method='post' action='c_my_post_details.php'>
              ...
              <a href='c_my_post_details.php?product_id=".$row['b_product_id'] ."'>
              <strong> REPLY THE VENDOR</strong></button></a><br/>   
              </form>
     ...
     <div class="modal-dialog">
         ...
         <div class="modal-content">
           <div class="modal-body">                   
             ...
             <form method="post" action="c_my_post_details.php" enctype="multipart/form-data">
...
$use = $_SESSION['user_name'];
 ...
 $sql = "SELECT * FROM client_demand_post,client_products_images 
     WHERE client_demand_post.b_product_id=client_products_images.product_id 
    AND client_demand_post.b_product_id= $p_id LIMIT 1";
  ...
  if (isset($_POST['complete'])) 
 {
   ...
   //$p_id  = $_GET['product_id'] ;
    ...
    $sql = "UPDATE client_demand_post SET product_status = '$product_st' WHERE b_product_id='$prod' ";
...
window.location='c_my_post_details.php'</script>";
...
$sql = "UPDATE client_product_comments SET client_reply = '$rep_post' WHERE product_id='$p' LIMIT 1";
