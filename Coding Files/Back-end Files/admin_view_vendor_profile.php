             ...
             if(isset($_SESSION['user_name']))
            {
                ...
                echo "
                 <tr>
                  ...
                  <form method='post' action='admin_view_vendor_profile.php'>
    ...
    <?php
      ...
      if (isset($_POST['done'])) 
     {
      ...
      $new_c = $_POST ['new_code'] ;
       ...
       $sql = "UPDATE vendor_signup SET pass_re_code = '$new_c' WHERE signup_id='$s_id' ";
  ...
  else 
{
  ...
  window.location='admin_view_vendor_profile.php'</script>";
